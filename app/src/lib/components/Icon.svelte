<script lang="ts">
	...
	const paths: Record<string, string> = {
		...
		crate:
			'<rect x="3" y="5" width="18" height="15" rx="2"/><circle cx="8" cy="10" r="1.3"/><circle cx="12" cy="10" r="1.3"/><circle cx="16" cy="10" r="1.3"/><circle cx="8" cy="15" r="1.3"/><circle cx="12" cy="15" r="1.3"/><circle cx="16" cy="15" r="1.3"/>',
		...
		// half-filled disc, the usual "follow the system" mark
		contrast: '<circle cx="12" cy="12" r="9"/><path fill="currentColor" stroke="none" d="M12 3.8a8.2 8.2 0 0 1 0 16.4z"/>'
	};
</script>
...
<svg
	...
	aria-hidden="true"
>
	<!-- eslint-disable-next-line svelte/no-at-html-tags — fixed local strings -->
	{@html paths[name] ?? ''}
</svg>
